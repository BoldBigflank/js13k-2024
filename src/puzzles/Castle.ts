...
export class Castle {
    ...
    reset() {
        ...
        boxes.forEach((boxData, index) => {
            ...
            const wall = BABYLON.MeshBuilder.CreateTiledBox(
                `castle-wall${index}`,
                {
                    width,
                    height,
            ...
            // Roof tile
            const roof = BABYLON.MeshBuilder.CreateTiledBox(
                `castle-roof${index}`,
                {
                    width: width - 0.01,
                    height: 0.3,
        ...
        const turrets = [
            ...
            [-13.5, 6.5, 6, 0.5, 1.5, 0], // 3 stubby on the west block
            [-13.5, 6.5, 4, 0.5, 1.5, 0], // ^
            [-11.5, 6.5, 2.5, 0.5, 1.5, 0], // ^
            ...
            [-2.5, 7, -3, 0.5, 2, 0], // 3 stubbies on SW Garden
            [0, 7, -5.5, 0.5, 2, 0],
            [3, 7, -5.5, 0.5, 2, 0],
